...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR="$background"
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR="$foreground"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"mailcount 9 255"
		"now_playing $color2 $background"
		"date_day $color8 $foreground"
		"date $color8 $foreground ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time $color8 $foreground ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
